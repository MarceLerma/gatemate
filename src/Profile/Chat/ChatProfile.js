    ...
    state={ 
        listadoChats: [
            ...
            },
            {
                ...
                nombreMatch1: 'Laura',
                chatMatch1:'Pero entonces no tenemos que preparar nada??',
                        ...
                        return(                
                            <div >
                                <div className='boxchatPerfilMain' >
                                   <Link to= {`/evento/${e.slug}`}>  <strong className='titleBoxChatPerfilMain'>{e.nombre} </strong> </Link>
                                   <div className='mainSubboxChatPerfilMain'>
